...
{\color{suave}\small Lo que le falta al grafo por dentro: 9 nodos que no cumplen lo que su marca promete.}\par
...
grafo—. Ésta mira hacia \textbf{adentro}: de los 189
conceptos que ya están, cuáles no cumplen lo que su propia marca promete.
Son \textbf{9} decisiones, y ninguna medición las había
...
\textbf{A · \texttt{lean=None} caducable} & marca de vértice, cero nombres, y un «no existe» fechado en agosto & \textbf{8} & \emph{aquí}\\
\textbf{B · marcados fuera} & marca \texttt{T} y sin embargo son nodos & \textbf{1} & \emph{aquí}\\
\textbf{C · fuera y con voz} & marca \texttt{T} y además dan nombres & \textbf{0} & \emph{aquí}\\
...
\begin{aviso}\small 
La tercera opción es la que más importa de las tres. Si es la correcta para la mayoría de los 1, lo que falta no son 1 decisiones sino \textbf{una marca nueva} —algo como \texttt{R} de enrutador— y la hoja se cierra de golpe. Si no lo es, hay que ir uno por uno.
\end{aviso}
...
\newpage
\section*{Montón A · 8 decisiones que pueden haber caducado}
...
\bottomrule\end{tabular}\par\smallskip
{\footnotesize\color{suave}Descartadas por genéricas: \texttt{theory}\,(48). Si el objeto existe hay que buscarlo a mano: sus palabras no distinguen.}\par\smallskip
\noindent$\square$\,{\small \textbf{sigue sin nombre} — la decisión aguanta}\par
\noindent$\square$\,{\small \textbf{ya no es verdad}, y el nombre que entra es: \dotfill}\par
\noindent$\square$\,{\small \textbf{la marca era lo que estaba mal} $\rightarrow$ pasa a: \rule{2em}{0.4pt}}\par
\medskip
...
\medskip
\newpage
\section*{Montón B · 1 vértices marcados fuera}
...
\medskip
\newpage
\section*{Montón C · 0 marcados fuera y con voz}
