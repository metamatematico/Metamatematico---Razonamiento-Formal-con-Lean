...
\texttt{MetamathProver/CategoryFoundations/}: \textbf{166}.
...
\midrule \multicolumn{3}{l}{\textit{patterns.py}} \\
  ...
  &  & \footnotesize modelo concreto: dos simples cuya composicion no es simple \\
  & \texttt{detect\_pattern\_in\_graph} & \texttt{enlaces\_complejos\_existen} \\
...
\item \texttt{MetamathProver/CategoryFoundations/} — 166 declaraciones.
\end{itemize}
