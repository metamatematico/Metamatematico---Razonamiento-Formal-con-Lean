...
es 29 de 32 (91\,\%). Todas las cifras
...
\toprule
 & Operaciones & \% \\
\midrule
Respaldadas por un teorema & 29 & 91 \\
Sin respaldo formal & 3 & 9 \\
Mapeo roto & 0 & 0 \\
\midrule
Total auditado & 32 & 100 \\
\bottomrule
\end{tabular}
\end{center}

\noindent Declaraciones formales disponibles en
\texttt{MetamathProver/CategoryFoundations/}: \textbf{150}.
...
\item \texttt{MetamathProver/CategoryFoundations/} — 150 declaraciones.
\end{itemize}
