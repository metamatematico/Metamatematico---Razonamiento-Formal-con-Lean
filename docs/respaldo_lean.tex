...
es 31 de 34 (91\,\%). Todas las cifras
...
\toprule
 & Operaciones & \% \\
\midrule
Respaldadas por un teorema & 31 & 91 \\
Sin respaldo formal & 3 & 9 \\
Mapeo roto & 0 & 0 \\
\midrule
Total auditado & 34 & 100 \\
\bottomrule
\end{tabular}
\end{center}

\noindent Declaraciones formales disponibles en
\texttt{MetamathProver/CategoryFoundations/}: \textbf{177}.
...
\midrule \multicolumn{3}{l}{\textit{complexity.py}} \\
  ...
  &  & \footnotesize MP es alcanzable en un preorden: que no se cumpla es del algoritmo \\
\midrule \multicolumn{3}{l}{\textit{patterns.py}} \\
...
\item \texttt{MetamathProver/CategoryFoundations/} — 177 declaraciones.
\end{itemize}
