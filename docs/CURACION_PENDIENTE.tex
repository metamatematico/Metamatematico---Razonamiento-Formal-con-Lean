...
\texttt{AlgebraicTopology.\allowbreak{}SimplexCategory.\allowbreak{}GeneratorsRelations.\allowbreak{}Basic} & T · es SimplexCategory presentada por generadores: la misma categoria con otro nombre, y dos nombres para un objeto gastan dos plazas\\
