...
The training pipeline integrates with the math-knowledge-space repository:
...
- math-knowledge-space - Knowledge bases and extraction pipeline
- dataset_schema.md - v5.0 schema specification
